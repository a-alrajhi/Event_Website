<template>
  <div class="min-h-screen bg-[var(--color-bg)] dark:bg-[var(--color-bg)] text-[var(--color-text)] flex flex-col space-y-4 font-[var(--font-poppins)]">
    <!-- Navbar -->
    <Navbar />
...
>
  ...
  <div class="relative z-10 max-w-xl px-6">
    <h1 class="text-3xl md:text-4xl font-bold mb-3 text-white drop-shadow-lg">
      Riyadh Events
    </h1>
    ...
    <div class="px-6">
      <SimilarEvents :currentEvent="null" @select-event="viewEventDetails" />
    </div>
