    ...
    <Transition name="modalDialog" appear>
        <div v-if="modelValue"
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden transform transition-all duration-300"
                ...
                <!-- Modal Header -->
                <div class="bg-gradient-to-r from-neutral-900 to-sky-900 px-6 py-4 text-white">
                ...
                <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-3">Choose a Date</h3>
                        <div class="grid gap-2">


                            <div v-for="(timeSlots, date) in groupedSlots" :key="date"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <!-- <span class="text-sm text-gray-500">{{ timeSlots.length }} slots</span> -->
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div v-if="selectedDate" key="time-slots" class="mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <button
                                    ...
                                    v-for="slot in groupedSlots[selectedDate]" :key="slot.id" :class="[
                                    ...
                                    <!-- Selected indicator -->
                                    <div v-if="selectedSlot && selectedSlot.id === slot.id"
                                        class="flex items-center mt-1">
                                        <svg class="w-4 h-4 text-green-600 mr-1" fill="currentColor"
                                            viewBox="0 0 20 20">
                ...
                <div class="bg-gray-50 px-6 py-4 flex gap-3 justify-end border-t">
                    ...
                    <!-- confirm button -->
                    <div>
                        <button :disabled="!selectedSlot" @click="confirm"
                            class="px-6 py-2 bg-gradient-to-r from-neutral-900 to-sky-900 text-white font-medium rounded-lg shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-sky-900 focus:ring-opacity-50">
